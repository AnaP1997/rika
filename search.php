 ...
 class="logo">
  ...
  animation-duration: 2.5s;" src="./components/riika.jpg" alt="">
   ...
   <nav style="font-family:Arial;font-size:18px; margin:30px; padding:10px; ">
    ...
    <div   class="links">
            <a style="text-decoration: none; color:#4A4E69;margin:0 20px 0 20px; " href="./private.php">Programari</a>
...
<div class="antet" style="display:flex;flex-direction:row;background-color:#E7D8C9;opacity:60%;height:80px;">
    <h3 style="margin-left:130px;">Nume</h3>
        <h3 style="margin-left:180px;">Serviciu</h3>
        <h3 style="margin-left:180px;">Specialist</h3>
        <h3 style="margin-left:180px;">Data</h3>
        <h3 style="margin-left:180px;">Observații</h3>
    </div>
    <?php
        ...
        ?>
                <div style="display:flex;flex-direction:row;height:100px;margin:20px 0 20px 0;">
                    <h4 style="margin-top:20px;flex: 1; text-align: center;"><?php echo $row['nume']; ?></h4>
                    <h4 style="margin-top:20px;flex: 1; text-align: center;"><?php echo $row['procedura']; ?></h4>
                    <h4 style="margin-top:20px;flex: 1; text-align: center;"><?php echo $row['specialist']; ?></h4>
                    <h4 style="margin-top:20px;flex: 1; text-align: center;"><?php echo $row['data']; ?></h4>
                    <h4 style="margin-top:20px;flex: 1; text-align: center;"><?php echo $row['observatii']; ?></h4>
...
<footer style="margin:350px;background-color:#E7D8C9;opacity:60%;height:80px;">
